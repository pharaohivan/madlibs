...
print("Enter 5 nouns")
noun = [input(),input(),input(),input(),input()]
print("Enter 4 verbs")
...
print("Here, in this place, there were " + noun[4] + "'s everywhere. I couldn't help but " + verb[1] + ".")
print("What even happened? Suddenly, the {} {} turned into {} {}".format( adjective[1], verb[2], adjective[2], verb[3]))
